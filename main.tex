...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{figures/splitting_mechanism.png}
\caption{Mechanism of grand coalition collapse. Split incentive $\Delta V$ increases monotonically with spite parameter $\sigma$, from approximately 0.002 at $\sigma = 0$ to 0.204 at $\sigma = 0.01$. Green points indicate stable configurations; red points indicate instability. The linear relationship demonstrates that splitting is driven by the strategic value of creating out-groups to harm, rather than efficiency considerations.}
